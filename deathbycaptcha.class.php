...
class DeathByCaptcha {
    ...
    public $useragent = "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:40.0) Gecko/20100101 Firefox/40.0";
    ...
    public function getBalance() {
        ...
        return (!empty($arr['balance']) && is_numeric($arr['balance'])) ? floatval($arr['balance']) : false;
    }
